...
<div align="center">
<img src="images/restricted-port-nat.png" width="500">
</br>[4.端口受限锥型NAT]
</div>
...
<div align="center">
<img src="images/pt_simulator_nat.png" width="500">
...
<div align="center">
<img src="images/nat_type_check.png" width="500">
</br>[8.NAT类型探测流程]
</div>
...
按照该步骤，我们编写了 NAT 类型探测的示例脚本([nat_check.py](./nat_check.py))。
